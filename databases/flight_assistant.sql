...
INSERT INTO sessions (userid, emailid, session_duration, context_window_length, user_preferences)
VALUES
(1, 2, INTERVAL '45 minutes', 6, '{"preferred_airlines": ["Emirates"], "budget": 600, "class": "Business"}');
...
LEFT JOIN emails e ON s.emailid = e.emailid
LEFT JOIN flights f ON u.userid = f.userid;
LEFT JOIN sessions s ON u.userid = s.userid
LEFT JOIN emails e ON s.emailid = e.emailid
LEFT JOIN flights f ON u.userid = f.userid;
